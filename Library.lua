...
local Library = {
    ...
    FontColor = Color3.fromRGB(255, 255, 255); -- Font
    MainColor = Color3.fromRGB(36, 36, 36); -- Main
    BackgroundColor = Color3.fromRGB(28, 28, 28); -- Background
    AccentColor = Color3.fromRGB(255, 0, 59); -- Accent
    OutlineColor = Color3.fromRGB(55, 55, 55); -- Outline
